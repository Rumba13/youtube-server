 ...
 private readonly videos: Video[] = [
  {
   ...
   channelId: '@Eva',
   duration: 123,
   preview: `${process.env.APP_URL}/video-preview-1.webp`,
   releaseDate: new Date('Jan 30, 2024 16:54:00'),
   title: 'Вич доктор перекурил НОВУЮ мету. DOTA 2',
   views: 6500,
   channelName: 'Eva',
   channelIcon: `${process.env.APP_URL}/ahegao-1.webp`,
  },
  {
   id: '2',
   channelId: '@Dima',
   duration: 123,
   preview: `${process.env.APP_URL}/video-preview-2.webp`,
  ...
  },
  {
   ...
   channelId: '@ZVERI',
   duration: 123,
   preview: `${process.env.APP_URL}/video-preview-3.webp`,
  ...
  },
  {
   ...
   channelId: '@Eva',
   duration: 123,
   preview: `${process.env.APP_URL}/video-preview-4.webp`,
  ...
  },
  {
   ...
   channelId: '@Kabanus',
   duration: 123,
   preview: `${process.env.APP_URL}/video-preview-5.webp`,
  ...
  },
  {
   ...
   channelId: '@Eva',
   duration: 123,
   preview: `${process.env.APP_URL}/video-preview-6.webp`,
  ...
  },
  {
   ...
   channelId: '@Eva',
   duration: 123,
   preview: `${process.env.APP_URL}/video-preview-7.webp`,
